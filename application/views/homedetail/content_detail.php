                        ...
                        <div class="product-info">
                            ...
                            <div class="single-add-to-cart">
                                <form action="#" class="cart-quantity">
                                    ...
                                    <!-- <div class="single-add-to-cart">
                                        <div class="single-add-to-cart bg-primary pt-10 " style="border-radius: 20px; " >
<center>
                                            <a href="<?= base_url('home/add_to_cart/' . $produk['id_produk']); ?>" style="">
                                                <i class="fa fa-shopping-cart bg-pri"  aria-hidden="true"></i> Tambahkan ke Keranjang
                                            </a>
</center>
                                        </div>
                                ...
                                <div class="product-social-sharing pt-25">
                                    <ul>
                                    <li class="facebook" style="width: 300px; height: 40px; line-height: 40px; border-radius: 10px; background-color: white; border: 1px solid orange;">
                                    ...
                                    <li class="facebook" style="width: 300px; height: 40px; line-height: 40px; border-radius: 10px; background-color: orange;">
                                        <a href="#" style="font-size: 15px;">
                                            <i></i>
